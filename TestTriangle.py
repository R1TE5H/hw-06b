...
class TestTriangles(unittest.TestCase):
    ...
    def testInvalidInputC(self):
        ...
        """
        self.assertEqual(classifyTriangle(201,2,3),'InvalidInput','Side > 200 should be invalid')
    ...
    def testInvalidInputD(self):
        ...
        """
        self.assertEqual(classifyTriangle(2.5,2,2),'InvalidInput','Non-integer side should be invalid')
    ...
    def testInvalidInputE(self):
        ...
        """
        self.assertEqual(classifyTriangle('a',2,2),'InvalidInput','Non-integer side should be invalid')
    ...
    def testNotATriangleC(self):
        ...
        """
        self.assertEqual(classifyTriangle(1,10,1),'NotATriangle','1,10,1 cannot form a triangle')
    ...
    def testNotATriangleD(self):
        ...
        """
        self.assertEqual(classifyTriangle(1,1,10),'NotATriangle','1,1,10 cannot form a triangle')
    ...
    def testEdgeCaseIsosceles(self):
        ...
        """
        self.assertEqual(classifyTriangle(200,199,199),'Isoceles','200,199,199 should be isosceles')
